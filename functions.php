...
function post($id)
{
	...
	// Try to build a Harmony\Voodoo\Post from passed value 
...
function term($id)
{
	// Try to build a Harmony\Voodoo\Term from passed value
	$term = null;
	...
	if ($term) {
		...
		return new Harmony\Voodoo\Term($data);
	}
...
function user($id)
{
	// Try to build a Harmony\Voodoo\User from passed value 
	if(is_numeric($id) || $id instanceof WP_User) {
		...
		return new Harmony\Voodoo\User($data);
	}
...
function setting($id = null)
{
	...
	return new Harmony\Voodoo\Setting($data, $id);
}